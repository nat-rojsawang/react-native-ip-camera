package ai.apdigital.ipcamera.common;
...
public class ScreenOrientationHelper implements SensorEventListener {
    ...
    public ScreenOrientationHelper(Activity activity, ImageButton button) {
        this(activity, button, null);
    }

    boolean isChecked = false;

    public ScreenOrientationHelper(Activity activity, ImageButton button1, ImageButton button2) {
        mActivity = activity;
        ...
        if (button1 != null) {
            ...
            button1.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mSensors != null) {
                        if (!isChecked) {
                            button1.setImageResource(R.drawable.btn_ap_small_selector);
                            landscape();}
                        else  {
                            button1.setImageResource(R.drawable.btn_ap_enlarge_selector);
                            portrait();
                        }
                    }
                }
...
/*
    ...
    private void calculateOrientation() {
        ...
        if (mSensors != null) {
            if (mSensors[1] == null) calculateByAccelerometer(mAccelerometerValues);
            else calculateByOrientation(values);
        }
    }
